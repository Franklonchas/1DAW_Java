...
public class ControladorDB {
    ...
    public ResultSet obtenerRegistros(String tabla) {
        String sentenciaSQL = "select nombre from " + tabla + " order by nombre";
        try {
    ...
    public AgendaDB obtenerContacto(String valor) {
        String sentenciaSQL = "select * from contacto where nombre = '" + valor + "'";
        System.out.println(sentenciaSQL);
        AgendaDB contacto = null;
        try {
            sentencia = conexion.createStatement();
            resultado = sentencia.executeQuery(sentenciaSQL);
            ...
            if (resultado.next()) {
                ...
                contacto = new AgendaDB(nom, dir, tlf, loc, email, edad);
            }
        } catch (SQLException evt) {
            System.err.println("No se pudo realizar la consulta");
            contacto = null;
    ...
    public void nuevoContacto(AgendaDB contacto) {
    ...
    public void modificarContacto(AgendaDB contacto) {
        String nom = contacto.getNombre();
        String dir = contacto.getDireccion();
        String tlf = contacto.getTelefono();
        String loc = contacto.getLocalidad();
